...
white = ['blue', 'yellow', 'green', 'orange', 'white', 'blue', 'orange', 'orange', 'red']
yellow = ['red' ,'white', 'yellow', 'orange', 'yellow', 'green' ,'white', 'green', 'red']
red = ['orange', 'white', 'green', 'green', 'red', 'red', 'blue', 'yellow', 'blue']
orange= ['green', 'orange', 'orange', 'red', 'orange', 'blue', 'red', 'white', 'white']
green = ['yellow', 'blue', 'yellow', 'white', 'green', 'yellow', 'blue', 'red', 'orange']
blue = ['white', 'green', 'white', 'yellow', 'blue', 'blue', 'yellow', 'red', 'green']
...
class InteractiveCube(plt.Axes):
    ...
    def _play_moves(self, event):
        ...
        for face, count in moves:
            ...
            self.rotate_face(moves[iii][0], moves[iii][1])
            iii+=1
            roo=1
            if iii >= len(moves):
                iii=len(moves)
    ...
    def _initialize_widgets(self):
        ...
        self._btn_play = widgets.Button(self._ax_play, 'Play Move')
        self._btn_play.on_clicked(self._play_moves)
        self._ax_undo= self.figure.add_axes([0.55, 0.125, 0.2, 0.075])
        self._btn_undo = widgets.Button(self._ax_undo, 'undo Move')
        self._btn_undo.on_clicked(self._undo_moves)
